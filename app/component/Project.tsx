...
export default function Project() {
    ...
    const Projects = () => (
        projectData.map((project, i) => (
            <a key={`project-${i}`} href="#" className="flex rounded-lg shadow hover:bg-gray-300 dark:hover:bg-gray-800">
    ...
    return (
        <div id="project-block" className="flex m-5 p-5 bg-gray-200 dark:bg-gray-900">
